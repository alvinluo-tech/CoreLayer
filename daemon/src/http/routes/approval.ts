...
approvalRoutes.get("/", withErrorHandling("approvals/list", async (c) => {
...
approvalRoutes.post("/expire-stale", withErrorHandling("approvals/expire-stale", async (c) => {
  const { approvalRequests } = getRepositories();
...
approvalRoutes.get("/:id", withErrorHandling("approvals/get", async (c) => {
  const { approvalRequests } = getRepositories();
 ...
 */
approvalRoutes.post("/:id/approve", withErrorHandling("approvals/approve", async (c) => {
  const { approvalRequests } = getRepositories();
  const id = c.req.param("id")!;
 ...
 */
approvalRoutes.post("/:id/deny", withErrorHandling("approvals/deny", async (c) => {
