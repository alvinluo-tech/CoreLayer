...
const mockServer = {
  config: { id: "srv-1", name: "Test Server", transport: "http", url: "http://localhost:3000", enabled: true },
...
describe("useMCPStore", () => {
  ...
  describe("disconnectServer", () => {
    it("disconnects and cascading refreshes servers + tools", async () => {
      ...
      mockListAllTools.mockResolvedValueOnce({ tools: [], count: 0, bySource: { native: 0, mcp: 0, skill: 0, rest: 0 } });
