<p align="center">
  <img src="./assets/corelayer-hero.png" alt="CoreLayer — powered by Jarvis" width="100%" />
</p>
...
| | 特性 | 说明 |
|---|---|---|
| <img src="./assets/icons/voice.svg" width="28" /> | **语音原生** | 唤醒词、ASR 识别、流式 LLM 响应、句级 TTS 播报、打断续听。 |
| <img src="./assets/icons/mcp.svg" width="28" /> | **MCP 优先** | 通过 Model Context Protocol 连接个人应用和外部工具。 |
| <img src="./assets/icons/tools.svg" width="28" /> | **工具感知** | 统一工具层，支持原生、MCP、技能和 REST 工具的结构化展示。 |
| <img src="./assets/icons/guard.svg" width="28" /> | **权限守护** | 基于风险等级的执行控制，支持异步确认、审计日志和超时处理。 |
| <img src="./assets/icons/models.svg" width="28" /> | **模型路由** | 跨 MiMo、Groq、OpenRouter、Ollama 及任意 OpenAI 兼容提供商路由请求。 |
| <img src="./assets/icons/memory.svg" width="28" /> | **本地优先存储** | SQLite 作为默认数据层，需要时可通过 Supabase 或 PostgreSQL 云同步。 |
...
<p align="center">
  <img src="./assets/coreling.png" alt="Coreling — Jarvis AI 核心伙伴" width="360" />
</p>
...
```text
assets/corelayer-hero.png    README 横幅
assets/coreling.png          助手头像
assets/icon.png              桌面应用图标
assets/icons/                功能模块图标
```
