...
| | 特性 | 说明 |
|---|---|---|
| <img src="./public/assets/icons/voice.svg" width="28" /> | **语音管线** | 唤醒词、ASR 识别、流式 LLM 响应、句级 TTS 播报、打断续听。 |
| <img src="./public/assets/icons/chat.svg" width="28" /> | **流式聊天** | SSE 流式传输，上下文感知工具调用、多轮记忆和自然语言解析。 |
| <img src="./public/assets/icons/mcp.svg" width="28" /> | **MCP 集成** | 通过 stdio、HTTP 和 SSE 连接个人应用和外部工具（Model Context Protocol）。 |
| <img src="./public/assets/icons/registry.svg" width="28" /> | **工具注册中心** | 统一工具层，支持原生、MCP、技能和 REST 工具的结构化展示和发现。 |
| <img src="./public/assets/icons/guard.svg" width="28" /> | **权限守卫** | 基于风险等级的执行控制（低/中/高/极高），支持异步确认和超时处理。 |
| <img src="./public/assets/icons/models.svg" width="28" /> | **模型路由** | 跨 MiMo、Groq、OpenRouter、Ollama 及任意 OpenAI 兼容提供商路由请求。 |
| <img src="./public/assets/icons/memory.svg" width="28" /> | **本地优先存储** | SQLite 作为默认数据层，需要时可通过 Supabase 或 PostgreSQL 云同步。 |
| <img src="./public/assets/icons/hotswap.svg" width="28" /> | **热切换存储** | 运行时在 SQLite、Supabase 和 PostgreSQL 之间切换，无需重启。 |
| <img src="./public/assets/icons/audit.svg" width="28" /> | **审计日志** | 追踪每次工具调用的耗时、风险等级、结果状态和权限决策。 |
| <img src="./public/assets/icons/control-center.svg" width="28" /> | **控制中心** | 桌面设置 UI，管理模型、MCP 服务器、工具、权限、语音和系统健康。 |
| <img src="./public/assets/icons/daemon.svg" width="28" /> | **守护进程管理** | Node.js 守护进程，支持健康检查、自动重启和进程生命周期管理。 |

### 个人工具

| | 特性 | 说明 |
|---|---|---|
| <img src="./public/assets/icons/todo.svg" width="28" /> | **智能任务** | 任务管理器，支持优先级、到期日、标签、自然语言创建和每日聚焦视图。 |
| <img src="./public/assets/icons/reading.svg" width="28" /> | **阅读追踪** | 书籍/文章跟踪，支持状态管理、分类、评分和阅读统计。 |
| <img src="./public/assets/icons/review.svg" width="28" /> | **每日复盘** | 自动每日/每周摘要，支持完成度指标、热门标签和趋势分析。 |
